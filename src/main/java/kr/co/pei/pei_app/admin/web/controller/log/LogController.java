package kr.co.pei.pei_app.admin.web.controller.log;
...
import kr.co.pei.pei_app.admin.application.service.log.LogService;
...
public class LogController {
    ...
    @GetMapping
    public ResponseEntity<ApiResult<Page<AdminLogResponseDTO>>> findAll(@ParameterObject @PageableDefault(
            sort = "createdAt", direction = DESC) Pageable pageable) {

        Page<AdminLogResponseDTO> logList = logService.findAll(pageable);
