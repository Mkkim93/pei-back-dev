...
import static kr.co.pei.pei_app.domain.entity.survey.enums.CategoryType.*;
...
public class DetailSurveyDTO {
    ...
    @QueryProjection
    public DetailSurveyDTO(Long id, String title, String category, Object content, LocalDateTime createdAt,
