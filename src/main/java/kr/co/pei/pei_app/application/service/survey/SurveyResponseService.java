...
import kr.co.pei.pei_app.application.dto.surveys.response.SurveyResponseDTO;
...
public class SurveyResponseService {
    ...
    @Transactional
    public void saveSurveyResponse(SurveyResponseDTO responseDTO) throws JsonProcessingException {
