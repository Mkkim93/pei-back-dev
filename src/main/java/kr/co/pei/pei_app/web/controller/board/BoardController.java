...
import kr.co.pei.pei_app.application.service.board.BoardTempService;
...
public class BoardController {
    ...
    @PostMapping("/temp")
    public ResponseEntity<ApiResult<Long>> temped(@RequestBody BoardTempDTO boardTempDTO) {
    ...
    @GetMapping("/temp")
    public ResponseEntity<ApiResult<Page<BoardFindTempDTO>>> findTemp(
            @ParameterObject @PageableDefault(page = 0, size = 10) Pageable pageable,
            @RequestParam(value = "searchKeyword", required = false) String searchKeyword
    ) {
        Page<BoardFindTempDTO> boardList = boardTempService.findPages(pageable, searchKeyword);
